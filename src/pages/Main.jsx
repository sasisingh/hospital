...
const Main = () => {
  return (
    <div>
      <div>
        <img src={main} alt='main' className='w-full opacity-30 h-[475px] absolute ' />
        <div className='grid sm:grid-cols-1  pt-10 sm:mx-20 md:grid-cols-2 md:mx-5 lg:grid-cols-2 mx-10'>
          ...
          <div>
            ...
            <h3 className='text-2xl font-bold text-sky-600 leading-normal'>We Provide best Treatment for you</h3>
            <p className='text-lg text mt-3 leading-normal'>Our treatment is very benificial for people as it is<br />
              very useful and efficient in treating an immense range of diseases and long-term illness.
            </p>
            <button className='my-10 bg-sky-500 rounded-2xl px-3 py-1 text-white cursor-pointer hover:bg-sky-600'>Purchase This Now</button>
