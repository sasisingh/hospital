  ...
  return (
    <div>
      <div className=''>
        ...
        <div className='flex md:max-w-[1080px] border rounded-sm border-gray-400 bg-white shadow-md shadow-slate-400  relative top-[-15px] lg:mx-auto md:mx-32'>
          <div className='w-3/4 mx-auto'>

            <form class=" p-4 lg:mx-auto md:mx-auto">
